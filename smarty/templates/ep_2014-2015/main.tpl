...
<html lang="{$lang}">
  ...
  <body>
      ...
      {literal}
        (function (d, w, c) {
            (w[c] = w[c] || []).push(function() {
                try {
      {/literal}
                    w.yaCounter{$t['yandex_metrica_code']} = new Ya.Metrika{literal}({
                        id:{/literal}{$t['yandex_metrica_code']}{literal},
                        clickmap:true,
                        trackLinks:true,
    ...
    {/literal}
    <noscript><div><img src="https://mc.yandex.ru/watch/{$t['yandex_metrica_code']}" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
